...
// Si les données sont un FormData, ne pas définir Content-Type manuellement
if (config.data instanceof FormData) {
  console.log('FormData détecté, préservation des en-têtes personnalisés');
}
  console.log('Requête envoyée:', config.method, config.url);
  console.log('En-têtes:', config.headers);
  console.log('Données:', config.data instanceof FormData ? 'FormData' : config.data);
